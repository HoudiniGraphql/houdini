						...
						edges: [
							{
								...
								node: {
									__typename: 'User',
									id: 'pagination-query-backwards-cursor:5',
									name: 'Will Smith',
								},
							},
							{
								...
								node: {
									__typename: 'User',
									id: 'pagination-query-backwards-cursor:6',
									name: 'Harrison Ford',
								},
							},
							{
								...
								node: {
									__typename: 'User',
									id: 'pagination-query-backwards-cursor:7',
									name: 'Eddie Murphy',
								},
							},
							{
								...
								node: {
									__typename: 'User',
									id: 'pagination-query-backwards-cursor:8',
									name: 'Clint Eastwood',
								},
							},
						],
