...
import type { CachePolicies, ConfigFile, PaginateModes } from '../../src/runtime/lib'
import { CachePolicy, PaginateMode } from '../../src/runtime/lib'
import {
	computeID,
	defaultConfigValues,
	keyFieldsForType,
	localApiEndpoint,
} from '../../src/runtime/lib/config'
