...
houdini is available on npm. For SvelteKit support, please install the `@next` tag

```sh
yarn add -D houdini@next houdini-preprocess@next
# or
npm install --save-dev houdini@next houdini-preprocess@next
```
