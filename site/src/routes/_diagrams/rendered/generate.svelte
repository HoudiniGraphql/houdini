<svg
	...
	width="100%"
	id="mermaid-1675115899537"
	{...$$props}
	><style>
		#mermaid-1675115899537 {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675115899537 .error-icon {
			fill: hsl(120, 100%, 30.0980392157%);
		}
		#mermaid-1675115899537 .error-text {
			fill: rgb(255, 101.4999999999, 255);
			stroke: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899537 .edge-thickness-normal {
			stroke-width: 2px;
		}
		#mermaid-1675115899537 .edge-thickness-thick {
			stroke-width: 3.5px;
		}
		#mermaid-1675115899537 .edge-pattern-solid {
			stroke-dasharray: 0;
		}
		#mermaid-1675115899537 .edge-pattern-dashed {
			stroke-dasharray: 3;
		}
		#mermaid-1675115899537 .edge-pattern-dotted {
			stroke-dasharray: 2;
		}
		#mermaid-1675115899537 .marker {
			fill: var(--diagram-line-color);
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675115899537 .marker.cross {
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675115899537 svg {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
		}
		#mermaid-1675115899537 .label {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			color: var(--diagram-text-color);
		}
		#mermaid-1675115899537 .cluster-label text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899537 .cluster-label span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899537 .label text,
		#mermaid-1675115899537 span {
			fill: var(--diagram-text-color);
			color: var(--diagram-text-color);
		}
		#mermaid-1675115899537 .node rect,
		#mermaid-1675115899537 .node circle,
		#mermaid-1675115899537 .node ellipse,
		#mermaid-1675115899537 .node polygon,
		#mermaid-1675115899537 .node path {
			fill: var(--diagram-background-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675115899537 .node .label {
			text-align: center;
		}
		#mermaid-1675115899537 .node.clickable {
			cursor: pointer;
		}
		#mermaid-1675115899537 .arrowheadPath {
			fill: undefined;
		}
		#mermaid-1675115899537 .edgePath .path {
			stroke: var(--diagram-line-color);
			stroke-width: 2px;
		}
		#mermaid-1675115899537 .flowchart-link {
			stroke: var(--diagram-line-color);
			fill: none;
		}
		#mermaid-1675115899537 .edgeLabel {
			background-color: var(--diagram-canvas-color);
			text-align: center;
		}
		#mermaid-1675115899537 .edgeLabel rect {
			opacity: 0.5;
			background-color: var(--diagram-canvas-color);
			fill: var(--diagram-canvas-color);
		}
		#mermaid-1675115899537 .cluster rect {
			fill: var(--diagram-subgraph-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675115899537 .cluster text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899537 .cluster span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899537 div.mermaidTooltip {
			position: absolute;
			text-align: center;
			max-width: 200px;
			padding: 2px;
		...
		#mermaid-1675115899537 .flowchartTitleText {
			text-anchor: middle;
			font-size: 18px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675115899537 :root {
		...
		><g class="root"
			><g class="clusters"
				><g id="subGraph0" class="cluster default"
			...
			><g class="nodes"
				><a transform="translate(345.68359375, 246.5)" xlink:href="#hash"
					><g title="hash hook" id="flowchart-artifact_hash-128" class="node default clickable"
						><rect
							height="39"
							width="47.3671875"
							y="-19.5"
						...
						/><g transform="translate(-16.18359375, -12)" style="" class="label"
							><foreignObject height="24" width="32.3671875"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(345.68359375, 157.5)" xlink:href="#artifactdata"
					><g
						...
						/><g transform="translate(-43.54296875, -12)" style="" class="label"
							><foreignObject height="24" width="87.0859375"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(345.68359375, 335.5)" xlink:href="#artifactend"
					><g title="artifactEnd hook" id="flowchart-artifact_e-130" class="node default clickable"
						><rect
							height="39"
							width="95.34375"
							y="-19.5"
						...
						/><g transform="translate(-40.171875, -12)" style="" class="label"
							><foreignObject height="24" width="80.34375"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(345.68359375, 19.5)" xlink:href="#beforegenerate"
					><g
						...
						/><g transform="translate(-56.8984375, -12)" style="" class="label"
							><foreignObject height="24" width="113.796875"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(39.4609375, 514.5)" xlink:href="#generate"
					><g title="generate hook" id="flowchart-generate-134" class="node default clickable"
						><rect
							height="39"
							width="78.921875"
							y="-19.5"
						...
						/><g transform="translate(-31.9609375, -12)" style="" class="label"
							><foreignObject height="24" width="63.921875"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(192.2109375, 514.5)" xlink:href="#includeruntime"
					><g
						...
						/><g transform="translate(-55.7890625, -12)" style="" class="label"
							><foreignObject height="24" width="111.578125"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(192.2109375, 603.5)" xlink:href="#transformruntime"
					><g
						...
						/><g transform="translate(-64.71875, -12)" style="" class="label"
							><foreignObject height="24" width="129.4375"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(345.68359375, 514.5)" xlink:href="#indexFile"
					><g title="indexfile hook" id="flowchart-indexFile-137" class="node default clickable"
						><rect
							height="39"
							width="80.3671875"
							y="-19.5"
						...
						/><g transform="translate(-32.68359375, -12)" style="" class="label"
							><foreignObject height="24" width="65.3671875"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(505.92578125, 514.5)" xlink:href="#graphqltagreturn"
					><g
						...
						/><g transform="translate(-62.55859375, -12)" style="" class="label"
							><foreignObject height="24" width="125.1171875"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(679.08984375, 514.5)" xlink:href="#clientplugins"
					><g
						...
						/><g transform="translate(-45.60546875, -12)" style="" class="label"
							><foreignObject height="24" width="91.2109375"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
