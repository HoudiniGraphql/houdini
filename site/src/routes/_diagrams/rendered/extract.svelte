<svg
	...
	viewBox="-8 -8 691.2265625 144"
	style="max-width: 691.2265625px;"
	xmlns:xlink="http://www.w3.org/1999/xlink"
	xmlns="http://www.w3.org/2000/svg"
	width="100%"
	id="mermaid-1675048061454"
	{...$$props}
	><style>
		#mermaid-1675048061454 {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675048061454 .error-icon {
			fill: hsl(120, 100%, 30.0980392157%);
		}
		#mermaid-1675048061454 .error-text {
			fill: rgb(255, 101.4999999999, 255);
			stroke: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061454 .edge-thickness-normal {
			stroke-width: 2px;
		}
		#mermaid-1675048061454 .edge-thickness-thick {
			stroke-width: 3.5px;
		}
		#mermaid-1675048061454 .edge-pattern-solid {
			stroke-dasharray: 0;
		}
		#mermaid-1675048061454 .edge-pattern-dashed {
			stroke-dasharray: 3;
		}
		#mermaid-1675048061454 .edge-pattern-dotted {
			stroke-dasharray: 2;
		}
		#mermaid-1675048061454 .marker {
			fill: var(--diagram-line-color);
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675048061454 .marker.cross {
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675048061454 svg {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
		}
		#mermaid-1675048061454 .label {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			color: var(--diagram-text-color);
		}
		#mermaid-1675048061454 .cluster-label text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061454 .cluster-label span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061454 .label text,
		#mermaid-1675048061454 span {
			fill: var(--diagram-text-color);
			color: var(--diagram-text-color);
		}
		#mermaid-1675048061454 .node rect,
		#mermaid-1675048061454 .node circle,
		#mermaid-1675048061454 .node ellipse,
		#mermaid-1675048061454 .node polygon,
		#mermaid-1675048061454 .node path {
			fill: var(--diagram-background-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675048061454 .node .label {
			text-align: center;
		}
		#mermaid-1675048061454 .node.clickable {
			cursor: pointer;
		}
		#mermaid-1675048061454 .arrowheadPath {
			fill: undefined;
		}
		#mermaid-1675048061454 .edgePath .path {
			stroke: var(--diagram-line-color);
			stroke-width: 2px;
		}
		#mermaid-1675048061454 .flowchart-link {
			stroke: var(--diagram-line-color);
			fill: none;
		}
		#mermaid-1675048061454 .edgeLabel {
			background-color: var(--diagram-canvas-color);
			text-align: center;
		}
		#mermaid-1675048061454 .edgeLabel rect {
			opacity: 0.5;
			background-color: var(--diagram-canvas-color);
			fill: var(--diagram-canvas-color);
		}
		#mermaid-1675048061454 .cluster rect {
			fill: var(--diagram-subgraph-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675048061454 .cluster text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061454 .cluster span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061454 div.mermaidTooltip {
			position: absolute;
			text-align: center;
			max-width: 200px;
			padding: 2px;
		...
		#mermaid-1675048061454 .flowchartTitleText {
			text-anchor: middle;
			font-size: 18px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675048061454 :root {
		...
		><g class="root"
			><g class="clusters" /><g class="edgePaths"
				...
				/><path
					...
					d="M531.594,19.5L535.76,19.5C539.927,19.5,548.26,19.5,557.764,22.807C567.267,26.114,577.941,32.727,583.278,36.034L588.614,39.341"
				/><path
					style="fill:none;"
					class="edge-thickness-normal edge-pattern-solid flowchart-link LS-schema LE-collect"
					id="L-schema-collect-0"
					d="M489.32,108.5L500.533,108.5C511.745,108.5,534.169,108.5,550.718,105.193C567.267,101.886,577.941,95.273,583.278,91.966L588.614,88.659"
				/></g
			><g class="edgeLabels"
				><g class="edgeLabel"
			...
			><g class="nodes"
				><a transform="translate(45.19921875, 19.5)" xlink:href="#extensions"
					><g title="extensions hook" id="flowchart-extensions-43" class="node default clickable"
						><rect
							height="39"
							width="90.3984375"
							y="-19.5"
						...
						/><g transform="translate(-37.69921875, -12)" style="" class="label"
							><foreignObject height="24" width="75.3984375"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(174.0625, 19.5)" xlink:href="#include"
					><g title="include hook" id="flowchart-include-44" class="node default clickable"
						><rect
							height="39"
							width="67.328125"
							y="-19.5"
						...
						/><g transform="translate(-26.1640625, -12)" style="" class="label"
							><foreignObject height="24" width="52.328125"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
				...
				><a transform="translate(293.109375, 19.5)" xlink:href="#exclude"
					><g title="exclude hook" id="flowchart-exclude-46" class="node default clickable"
						><rect
							height="39"
							width="70.765625"
							y="-19.5"
						...
						/><g transform="translate(-27.8828125, -12)" style="" class="label"
							><foreignObject height="24" width="55.765625"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
						...
						></g
					></a
				><a transform="translate(455.04296875, 19.5)" xlink:href="#extractDocuments"
					><g title="extractDocuments hook" id="flowchart-extract-48" class="node default clickable"
						><rect
							height="39"
							width="153.1015625"
							y="-19.5"
							...
							style=""
							class="basic label-container"
						/><g transform="translate(-69.05078125, -12)" style="" class="label"
							><foreignObject height="24" width="138.1015625"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
					...
					></a
				><g
					transform="translate(628.41015625, 64)"
					...
					><circle height="63" width="93.6328125" r="46.81640625" ry="0" rx="0" style="" /><g
						...
						style=""
						class="label"
						><foreignObject height="48" width="78.6328125"
							><div
								style="display: inline-block; white-space: nowrap;"
								xmlns="http://www.w3.org/1999/xhtml"
							>
						...
						></g
					></g
				><a transform="translate(455.04296875, 108.5)" xlink:href="#schema"
					><g title="schema hook" id="flowchart-schema-51" class="node default clickable"
						><rect
							height="39"
							width="68.5546875"
							y="-19.5"
						...
						/><g transform="translate(-26.77734375, -12)" style="" class="label"
							><foreignObject height="24" width="53.5546875"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
