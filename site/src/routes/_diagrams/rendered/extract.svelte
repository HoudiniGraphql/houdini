<svg
	...
	width="100%"
	id="mermaid-1675115899508"
	{...$$props}
	><style>
		#mermaid-1675115899508 {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675115899508 .error-icon {
			fill: hsl(120, 100%, 30.0980392157%);
		}
		#mermaid-1675115899508 .error-text {
			fill: rgb(255, 101.4999999999, 255);
			stroke: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899508 .edge-thickness-normal {
			stroke-width: 2px;
		}
		#mermaid-1675115899508 .edge-thickness-thick {
			stroke-width: 3.5px;
		}
		#mermaid-1675115899508 .edge-pattern-solid {
			stroke-dasharray: 0;
		}
		#mermaid-1675115899508 .edge-pattern-dashed {
			stroke-dasharray: 3;
		}
		#mermaid-1675115899508 .edge-pattern-dotted {
			stroke-dasharray: 2;
		}
		#mermaid-1675115899508 .marker {
			fill: var(--diagram-line-color);
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675115899508 .marker.cross {
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675115899508 svg {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
		}
		#mermaid-1675115899508 .label {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			color: var(--diagram-text-color);
		}
		#mermaid-1675115899508 .cluster-label text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899508 .cluster-label span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899508 .label text,
		#mermaid-1675115899508 span {
			fill: var(--diagram-text-color);
			color: var(--diagram-text-color);
		}
		#mermaid-1675115899508 .node rect,
		#mermaid-1675115899508 .node circle,
		#mermaid-1675115899508 .node ellipse,
		#mermaid-1675115899508 .node polygon,
		#mermaid-1675115899508 .node path {
			fill: var(--diagram-background-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675115899508 .node .label {
			text-align: center;
		}
		#mermaid-1675115899508 .node.clickable {
			cursor: pointer;
		}
		#mermaid-1675115899508 .arrowheadPath {
			fill: undefined;
		}
		#mermaid-1675115899508 .edgePath .path {
			stroke: var(--diagram-line-color);
			stroke-width: 2px;
		}
		#mermaid-1675115899508 .flowchart-link {
			stroke: var(--diagram-line-color);
			fill: none;
		}
		#mermaid-1675115899508 .edgeLabel {
			background-color: var(--diagram-canvas-color);
			text-align: center;
		}
		#mermaid-1675115899508 .edgeLabel rect {
			opacity: 0.5;
			background-color: var(--diagram-canvas-color);
			fill: var(--diagram-canvas-color);
		}
		#mermaid-1675115899508 .cluster rect {
			fill: var(--diagram-subgraph-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675115899508 .cluster text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899508 .cluster span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675115899508 div.mermaidTooltip {
			position: absolute;
			text-align: center;
			max-width: 200px;
			padding: 2px;
		...
		#mermaid-1675115899508 .flowchartTitleText {
			text-anchor: middle;
			font-size: 18px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675115899508 :root {
				...
				><a transform="translate(451.296875, 19.5)" xlink:href="#extractdocuments"
					><g title="extractDocuments hook" id="flowchart-extract-48" class="node default clickable"
						...
						/><g transform="translate(-65.3046875, -12)" style="" class="label"
							><foreignObject height="24" width="130.609375"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
