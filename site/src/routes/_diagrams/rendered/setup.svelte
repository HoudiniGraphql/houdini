<svg
	...
	viewBox="-8 -8 408.3515625 55"
	style="max-width: 408.3515625px;"
	xmlns:xlink="http://www.w3.org/1999/xlink"
	xmlns="http://www.w3.org/2000/svg"
	width="100%"
	id="mermaid-1675048061420"
	{...$$props}
	><style>
		#mermaid-1675048061420 {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675048061420 .error-icon {
			fill: hsl(120, 100%, 30.0980392157%);
		}
		#mermaid-1675048061420 .error-text {
			fill: rgb(255, 101.4999999999, 255);
			stroke: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061420 .edge-thickness-normal {
			stroke-width: 2px;
		}
		#mermaid-1675048061420 .edge-thickness-thick {
			stroke-width: 3.5px;
		}
		#mermaid-1675048061420 .edge-pattern-solid {
			stroke-dasharray: 0;
		}
		#mermaid-1675048061420 .edge-pattern-dashed {
			stroke-dasharray: 3;
		}
		#mermaid-1675048061420 .edge-pattern-dotted {
			stroke-dasharray: 2;
		}
		#mermaid-1675048061420 .marker {
			fill: var(--diagram-line-color);
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675048061420 .marker.cross {
			stroke: var(--diagram-line-color);
		}
		#mermaid-1675048061420 svg {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			font-size: 16px;
		}
		#mermaid-1675048061420 .label {
			font-family: 'trebuchet ms', verdana, arial, sans-serif;
			color: var(--diagram-text-color);
		}
		#mermaid-1675048061420 .cluster-label text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061420 .cluster-label span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061420 .label text,
		#mermaid-1675048061420 span {
			fill: var(--diagram-text-color);
			color: var(--diagram-text-color);
		}
		#mermaid-1675048061420 .node rect,
		#mermaid-1675048061420 .node circle,
		#mermaid-1675048061420 .node ellipse,
		#mermaid-1675048061420 .node polygon,
		#mermaid-1675048061420 .node path {
			fill: var(--diagram-background-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675048061420 .node .label {
			text-align: center;
		}
		#mermaid-1675048061420 .node.clickable {
			cursor: pointer;
		}
		#mermaid-1675048061420 .arrowheadPath {
			fill: undefined;
		}
		#mermaid-1675048061420 .edgePath .path {
			stroke: var(--diagram-line-color);
			stroke-width: 2px;
		}
		#mermaid-1675048061420 .flowchart-link {
			stroke: var(--diagram-line-color);
			fill: none;
		}
		#mermaid-1675048061420 .edgeLabel {
			background-color: var(--diagram-canvas-color);
			text-align: center;
		}
		#mermaid-1675048061420 .edgeLabel rect {
			opacity: 0.5;
			background-color: var(--diagram-canvas-color);
			fill: var(--diagram-canvas-color);
		}
		#mermaid-1675048061420 .cluster rect {
			fill: var(--diagram-subgraph-color);
			stroke: var(--diagram-border-color);
			stroke-width: 1px;
		}
		#mermaid-1675048061420 .cluster text {
			fill: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061420 .cluster span {
			color: rgb(255, 101.4999999999, 255);
		}
		#mermaid-1675048061420 div.mermaidTooltip {
			position: absolute;
			text-align: center;
			max-width: 200px;
			padding: 2px;
		...
		#mermaid-1675048061420 .flowchartTitleText {
			text-anchor: middle;
			font-size: 18px;
			fill: var(--diagram-text-color);
		}
		#mermaid-1675048061420 :root {
			...
			><g class="nodes"
				...
				><a transform="translate(232.57421875, 19.5)" xlink:href="#env"
					><g title="env hook" id="flowchart-env-17" class="node default clickable"
						...
						></g
					></a
				><a transform="translate(347.5390625, 19.5)" xlink:href="#afterLoad"
					><g title="afterLoad hook" id="flowchart-afterLoad-19" class="node default clickable"
						><rect
							...
							style=""
							class="basic label-container"
						/><g transform="translate(-37.3125, -12)" style="" class="label"
							><foreignObject height="24" width="74.625"
								><div
									style="display: inline-block; white-space: nowrap;"
									xmlns="http://www.w3.org/1999/xhtml"
								>
