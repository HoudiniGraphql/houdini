...
Before diving in, the [architecture guide](~/core/architecture) is worth a read. It explains how the compiler's process model works, how plugins communicate, and how the shared database fits together. That context makes the rest of this document a lot easier to follow.
