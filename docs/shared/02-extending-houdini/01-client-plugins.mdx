...
```typescript title="src/plugins/custom_plugin.ts&typescriptToggle=true"
...
A plugin can return any combination of hook objects, `null`, or arrays of hooks. This is useful for toggling functionality based on configuration:
