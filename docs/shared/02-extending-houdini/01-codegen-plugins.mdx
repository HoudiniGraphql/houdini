...
[Config reference](/svelte/api/config#adding-plugins).
...
Svelte-specific extraction example:
...
the document. This example is Svelte-specific:
...
[client plugins](/svelte/api/client-plugins) that want to add a generated portion. For example,
