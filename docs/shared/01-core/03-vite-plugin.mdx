...
power [its GraphQL APIs](~/loading-data/queries).
...
The plugin can be optionally configured with an object containing any of the [config values](~/core/config) as well as
