...
`houdini.config.js` file. More info in the [config section](/svelte/api/config#fields).
...
query string. The easiest way to do this is to define a [client plugin](/svelte/api/client-plugins).
