...
_More information about the config file can be found [here](/svelte/api/config)._
...
_More information about the client file can be found [here](/svelte/api/client)._
