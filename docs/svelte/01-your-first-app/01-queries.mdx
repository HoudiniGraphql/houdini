...
<AsideAccordion variant="tip" title="What happened to load?">
...
For more information, check out the [query api docs](/svelte/api/query#query-variables).
...
define, check out the [query api docs](/svelte/api/query#hooks).
