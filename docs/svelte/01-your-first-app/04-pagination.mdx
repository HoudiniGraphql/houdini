...
If you want to read more about pagination, head over to the [pagination guide](/svelte/pagination/).
...
For a more in-depth summary of what you can do with `@paginate`, you can check out the [Pagination Guide](/svelte/pagination/).
...
If you want to read more about what Houdini can do, we recommending checking out the [Working with GraphQL](/svelte/graphql-documents/) guide next.
