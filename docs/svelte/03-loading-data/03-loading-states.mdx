...
we're going to be building a loading screen for the Pokédex that we constructed in the [Getting Started](/svelte/getting-started/) guide:
...
If you followed along in the [Getting Started Guide](/svelte/getting-started/) then you know that if we click on the
