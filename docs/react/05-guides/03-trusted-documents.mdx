...
`houdini.config.js` file. More info in the [config section](/react/api/config/#fields).
...
query string. The easiest way to do this is to define a [client plugin](/react/api/client-plugins/).
