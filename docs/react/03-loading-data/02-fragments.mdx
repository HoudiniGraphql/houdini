...
The `@plural` directive solves this by marking the fragment as list shaped. The reference becomes an array and `useFragment` returns an array of data, so a single component can own "render this whole list":
