...
func ValidateUnknownDirective[PluginConfig any](ctx context.Context, db plugins.DatabasePool[PluginConfig], errs *plugins.ErrorList) {
	...
	for _, usage := range usages {
		errs.Append(&plugins.Error{
			Message:   fmt.Sprintf("Unknown directive '@%s'", usage.directive),
			Kind:      plugins.ErrorKindValidation,
