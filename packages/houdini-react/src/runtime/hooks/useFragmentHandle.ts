...
import { useQueryMeta, type QueryMeta } from './useQueryMeta'
...
>(
...
): [_Data | null, QueryMeta<_PaginationArtifact, _Data, _Input>] {
	...
	const handle = useQueryMeta<_PaginationArtifact, _Data, _Input>({
