...
export function useFragment<
	...
	_Input extends {} = {}
>(reference: _Data | { [fragmentKey]: _ReferenceType } | null, artifact: FragmentArtifact) {
...
Please ensure that you have passed a record that has ${artifact.name} mixed into it.`
		)
	}
	...
	const [storeValue] = useLiveDocument({
		artifact: artifact,
		variables,
		initialValue,
		send: {
