import { getFieldsForType } from 'houdini/runtime.js'
import type { DocumentArtifact, GraphQLObject, GraphQLValue } from 'houdini/runtime.js'
import { defaultComponentField, type Cache } from 'houdini/runtime/cache.js'
