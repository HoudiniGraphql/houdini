		...
		return {
			...
			network(ctx, { resolve }) {
				resolve(ctx, {
					...
					stale: false,
					source: DataSource.Cache,
					// biome-ignore lint/style/noNonNullAssertion: Test context variables are guaranteed to exist
...
export function createStore(
	...
	// biome-ignore lint/suspicious/noExplicitAny: Test store can use any variable type
