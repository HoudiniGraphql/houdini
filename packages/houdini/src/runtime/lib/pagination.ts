...
>({
	...
	return {
		loadNextPage: ({
			...
			// biome-ignore lint/suspicious/noExplicitAny: Pagination input can have various field combinations
			const input: any = {
		...
		async fetch(
			...
			// build up the variables to pass to the query
			// biome-ignore lint/suspicious/noExplicitAny: Query variables can be any GraphQL variable type
