...
// biome-ignore lint/suspicious/noExplicitAny: Crypto algorithm type varies by implementation
...
export interface JwtHeader {
	...
	// biome-ignore lint/suspicious/noExplicitAny: JWT header can contain any additional fields
	[key: string]: any
}
...
export interface JwtPayload {
	...
	// biome-ignore lint/suspicious/noExplicitAny: JWT payload can contain any additional claims
	[key: string]: any
}
