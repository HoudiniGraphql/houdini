...
test('loading state on mixed abstract type', async function () {
	...
	expect(docs[0]).toMatchInlineSnapshot(`
		...
		"HoudiniHash=b673be99e3b55f079434a8e24acb3afe9e3a278d99e4e258a433eec0b21e6e39";
	`)
})
...
test('loading state on multiple branches of an abstract selection', async function () {
	...
	expect(docs[0]).toMatchInlineSnapshot(`
		...
		"HoudiniHash=567fd887397a9072784a6320f8609a66bdb69a3d3cbb791428c8cd342dccd67f";
	`)
})
...
test('loading state on inline fragments', async function () {
	...
	expect(docs[0]).toMatchInlineSnapshot(`
		...
		"HoudiniHash=ed0970b3886e2211f38a0a3d328601407380f13907c5a69a5bd462f7aca6741b";
	`)
})
...
test('loading cascade', async function () {
	...
	expect(docs[0]).toMatchInlineSnapshot(`
		...
		"HoudiniHash=10f12e15c7975a8f61f8d519aaf69dea273054da2d8feaf27803aceb7e4f3e1d";
	`)
})
